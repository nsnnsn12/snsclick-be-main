...
public class OrderService implements OrderUseCase{
	...
	@Override
	public Order createOrder(OrderCommandFactory orderCommandFactory) throws NotEnoughApiAmountException, NotEnoughConsumerAmountException {
		/* TODO
		...
		Order order = orderCommandFactory.getCharge(InternalParameterForOrder.builder().build());
