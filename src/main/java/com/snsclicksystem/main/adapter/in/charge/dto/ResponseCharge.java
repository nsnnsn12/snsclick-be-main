...
public class ResponseCharge {
	public ResponseCharge(ChargedInfo chargedInfo) {
		this.setPayType(chargedInfo.getChargeType());
		this.setAmount(chargedInfo.getRealAmountPaid());
		this.setOrderId(chargedInfo.getId());
		this.setOrderName("포인트 충전");
		this.setCustomerName(chargedInfo.getMemberEmail());
		this.setSuccessUrl(chargedInfo.getSuccessUrl());
		this.setFailUrl(chargedInfo.getFailUrl());
		this.setFailReason(chargedInfo.getFailReason());
		this.setCancelYN(chargedInfo.getIsCancel());
		this.setCancelReason(chargedInfo.getCancelReason());
		this.setCreatedAt(chargedInfo.getCreatedAt());
	}
